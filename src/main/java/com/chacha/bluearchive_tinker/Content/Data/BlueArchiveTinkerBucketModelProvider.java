...
public class BlueArchiveTinkerBucketModelProvider extends GenericDataProvider {
    private final String modId;

    public BlueArchiveTinkerBucketModelProvider(PackOutput packOutput, String modId) {
